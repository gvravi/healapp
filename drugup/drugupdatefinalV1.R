...
drugUpdate <- NULL
for( page in 618:1000) { #there is no zero page hence started with 1
...
write.csv(drugUpdate, file = "C:/Users/avon/Documents/R/drugupdate/drugUpdate618_1000.csv",row.names=FALSE)
